...
EOF
    ...
    run_podman build -f $tmpdir/build/Containerfile --output type=local,dest=$tmpdir/output $tmpdir/build
...
EOF
    ...
    run_podman build -f $tmpdir/build/Containerfile --output type=tar,dest=$tmpdir/output.tar $tmpdir/build
